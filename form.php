...
$q = $con->prepare("INSERT INTO appointments(name,date,email,carmodel,phone,issue,time,image,description) VALUES('$name','$date','$email','$model','$phone','$issue','$time','$target_file','$description')");
$q->execute();
